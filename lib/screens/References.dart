        ...
        Container(color: Colors.orange,)*/
          Align(
              ...
              child: Container(
                ...
                child: Image.network(
                    "https://raw.githubusercontent.com/samyak1209/change_managent/master/images/officeEnv.jpg"),
              )),
          Align(
            alignment: Alignment.bottomCenter,
            child: Container(
            ...
            child: Container(
                ...
                child: //Text('Management',style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      'Lorem ipsum dolor siteiusmod tempor incididunt ut labore et dolore magna aliqua.',
                      style: TextStyle(color: Colors.white, fontSize: 18),
                    ),
                  ],
                )),
            ...
            child: Container(
                ...
                child: //Text('Management',style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      'Lorem ipsum dolor sit amet, consectetur aor incididunt ut labore et dolore magna aliqua.',
                      style: TextStyle(color: Colors.white, fontSize: 18),
                    ),
                  ],
                )),
